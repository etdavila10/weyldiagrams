...
const omegaY = (x,y) => (Math.sqrt(2)/2.) * x;
...
$('#generate').click(function() {
    ...
    if (m % 2 == 0) {
        ...
        alert('Please make sure "m" is even');
    }
});

function generate(n,m) {
    // Inequality names based off paper
    const j1 = (x,y) => (y - m)/2. + x - n;
    const j2 = (x,y) => x + y - n - m;
    const j3 = (x,y) => (y - m)/2. - n - 1;
    const j4 = (x,y) => x - n - m - 1.;
    const j5 = (x,y) => -x - n - m - 3.;
    const j6 = (x,y) => (-y - m)/2. - n - 2.;
    const j7 = (x,y) => (-y - m)/2. - x - n - 3.;
    const j8 = (x,y) => -x - y - n - m - 4.;
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j1(c1, 2.*c2) >= 0 && j2(c1, 2.*c2) >= 0
                && j3(c1, 2.*c2) < 0 && j4(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j3(c1, 2.*c2) >= 0 && j2(c1, 2.*c2) >= 0
                && j1(c1, 2.*c2) < 0 && j5(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j1(c1, 2.*c2) >= 0 && j4(c1, 2.*c2) >= 0
                && j2(c1, 2.*c2) < 0 && j6(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j3(c1, 2.*c2) >= 0 && j5(c1, 2.*c2) >= 0
                && j2(c1, 2.*c2) < 0 && j7(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j6(c1, 2.*c2) >= 0 && j4(c1, 2.*c2) >= 0
                && j8(c1, 2.*c2) < 0 && j1(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j7(c1, 2.*c2) >= 0 && j5(c1, 2.*c2) >= 0
                && j8(c1, 2.*c2) < 0 && j3(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j6(c1, 2.*c2) >= 0 && j8(c1, 2.*c2) >= 0
                && j4(c1, 2.*c2) < 0 && j7(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j7(c1, 2.*c2) >= 0 && j8(c1, 2.*c2) >= 0
                && j5(c1, 2.*c2) < 0 && j6(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j1(c1, 2.*c2) >= 0 && j3(c1, 2.*c2) >= 0
                && j4(c1, 2.*c2) < 0 && j5(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j2(c1, 2.*c2) >= 0 && j4(c1, 2.*c2) >= 0
                && j3(c1, 2.*c2) < 0 && j6(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j2(c1, 2.*c2) >= 0 && j5(c1, 2.*c2) >= 0
                && j1(c1, 2.*c2) < 0 && j7(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j1(c1, 2.*c2) >= 0 && j6(c1, 2.*c2) >= 0
                && j2(c1, 2.*c2) < 0 && j8(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j5(c1, 2.*c2) >= 0 && j8(c1, 2.*c2) >= 0
                && j6(c1, 2.*c2) < 0 && j3(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j6(c1, 2.*c2) >= 0 && j7(c1, 2.*c2) >= 0
                && j5(c1, 2.*c2) < 0 && j4(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j2(c1, 2.*c2) >= 0 && j6(c1, 2.*c2) >= 0
                && j3(c1, 2.*c2) < 0 && j8(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j7(c1, 2.*c2) >= 0 && j4(c1, 2.*c2) >= 0
                && j5(c1, 2.*c2) < 0 && j1(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
    ...
    for (c1 of vals) {
        for (c2 of vals) {
            if (j6(c1, 2.*c2) >= 0 && j5(c1, 2.*c2) >= 0
                && j4(c1, 2.*c2) < 0 && j3(c1, 2.*c2) < 0) {
                xvals.push(c1);
                yvals.push(2.*c2);
            }
        }
